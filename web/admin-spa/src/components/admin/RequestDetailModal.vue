    ...
    <template #header>
      <div class="flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap sm:items-center">
        ...
        <div class="flex items-center gap-2 self-start sm:self-center">
          <el-tag v-if="imageGenerationLabel" effect="dark" type="warning">
            🖼️ {{ imageGenerationLabel }}
          </el-tag>
        ...
        <div class="grid gap-4 xl:grid-cols-[1.2fr,0.8fr]">
          ...
          >
            ...
            <div class="grid gap-3 md:grid-cols-2">
              ...
              <div v-if="detail.imageGeneration && detail.imageGeneration.count">
                <p class="field-label">图片生成</p>
                <p class="field-value text-amber-600 dark:text-amber-400">
                  {{ detail.imageGeneration.count }} 张
                </p>
                <p class="field-sub">
                  {{
                    [detail.imageGeneration.format, detail.imageGeneration.size]
                      .filter(Boolean)
                      .join(' · ') || '格式未知'
                  }}
                </p>
