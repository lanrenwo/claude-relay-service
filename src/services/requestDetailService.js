...
class RequestDetailService {
  ...
  async _enrichRecords(records = [], apiKeyCache = new Map(), accountCache = new Map()) {
    ...
    for (const record of records) {
      ...
      const imageGen = normalizeImageGenerationMeta(displayRecord.imageGeneration)

      enriched.push({
        ...displayRecord,
        costBreakdown: fillImageCostBreakdown(displayRecord.costBreakdown || null, imageGen),
        realCostBreakdown: fillImageCostBreakdown(displayRecord.realCostBreakdown || null, imageGen),
